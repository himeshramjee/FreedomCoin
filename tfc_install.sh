...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Freedomcoin.conf'
CONFIGFOLDER='/root/.Freedomcoin'
COIN_DAEMON='Freedomcoind'
COIN_CLI=
COIN_PATH='/usr/local/bin/'
# COIN_TGZ='https://github.com/Realbityoda/FreedomCoin/releases/download/v1.0.0.2/Freedomcoin.zip'
COIN_TGZ='http://explorer.freedom-coin.io/wallets/FreedomCoin-Core.Linux.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Freedomcoin'
COIN_PORT=7118
RPC_PORT=7117
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/FreedomCoin/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}VPS_IP:PORT ${GREEN}$NODEIP:$COIN_PORT${NC}"
 ...
 echo -e "${GREEN}Freedomcoind masternode status${NC}"
 echo -e "${GREEN}Freedomcoind getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always excepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}TFC: tVVdQwKRVBB4AfAFWR2Guiw1RWEsEpyg8a${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
}
